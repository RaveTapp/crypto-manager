...
function useCryptoMenuStateInternal(marketData, selectedCryptos) {
...
export function CryptoMenuProvider({ children, marketData, selectedCryptos }) {
  const state = useCryptoMenuStateInternal(marketData, selectedCryptos);
  return (
